...
const content = [
	{
		title: 'Innovation',
		info:
			'Constantly pushing the boundaries of digital creativity.',
		image:
			'https://deveb.co/static/media/vim.2c5e9ce4.jpg',
	},
	{
		title: 'Quality',
		info:
		...
		image:
			'https://deveb.co/static/media/dopop2.3974e9e7.jpg',
	},
	{
		title: 'Collaboration',
		info:
		...
		image:
			'https://deveb.co/static/media/newdopegood.6e57b4b4.jpg',
	},
	{
		title: 'Integrity',
		info:
...
const Approch = () => {
	...
	useGSAP(() => {
		const titleSplit = SplitType.create(
			titleRef.current,
			{
				types: 'words',
			}
		...
		const contentAnimation = gsap.to(
			contentRef.current,
			{
				y: 0,
				filter: 'blur(0px)',
	...
	return (
		<Container>
			<Wrapper>
				<Title ref={titleRef}>
					We activate brands across global touchpoints,
					from campaigns to events and beyond.
				</Title>
				<ContentWrapper>
